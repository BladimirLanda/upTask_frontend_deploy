...
Es una regla de validación que se le puede pasar a register en React Hook Form.
Permite validar que el valor ingresado coincida con una expresión regular (regex).
    '/\S+@\S+\.\S+/' - Validación rápida email
*/
function LoginView() {
    //Navigate
